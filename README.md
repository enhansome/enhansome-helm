...
* [OpenStack](https://github.com/openstack/openstack-helm) ⭐ 575 | 🐛 0 | 🌐 Shell | 📅 2026-09-03 - various charts by the OpenStack project
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 133 | 🐛 169 | 🌐 TypeScript | 📅 2026-09-08 - AI-powered multi-cluster Kubernetes management console with built-in Helm chart for one-command deployment
...
* [Helm Diff](https://github.com/databus23/helm-diff) ⭐ 3,489 | 🐛 53 | 🌐 Go | 📅 2026-09-07 - Plugin that shows a diff explaing what a `helm upgrade` and `helm rollback` would change. It can also compare two separate revisions of the release.
* [Helm Secrets](https://github.com/jkroepke/helm-secrets) ⭐ 2,027 | 🐛 1 | 🌐 Shell | 📅 2026-09-04 - Plugin to manage and store secrets safely.
* [Helm Unittest](https://github.com/helm-unittest/helm-unittest) ⭐ 1,390 | 🐛 86 | 🌐 Go | 📅 2026-09-02 - Plugin that enables you to run BDD style unit tests against rendered Helm charts. Adds the `helm unittest` command to execute tests.
...
* [Helm Schema](https://github.com/dadav/helm-schema) ⭐ 281 | 🐛 11 | 🌐 Go | 📅 2026-09-08 - Auto-generate jsonschema files for helm charts.
...
* [Helmsman](https://github.com/Praqma/helmsman) ⭐ 1,493 | 🐛 1 | 🌐 Go | 📅 2026-09-06 - Helmsman provides a declarative way of installing charts, features terraform-like desired state file approach and security enhancements
...
* [Chart Releaser](https://github.com/helm/chart-releaser) ⭐ 783 | 🐛 57 | 🌐 Go | 📅 2026-09-07 - Helps Turn GitHub Repositories into Helm Chart Repositories
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 133 | 🐛 169 | 🌐 TypeScript | 📅 2026-09-08 - Multi-cluster Kubernetes dashboard with Helm chart deployment, deployed via its own Helm chart for easy installation
...
* [helm-unittest](https://github.com/helm-unittest/helm-unittest) ⭐ 1,390 | 🐛 86 | 🌐 Go | 📅 2026-09-02 - BDD styled unit test framework for Kubernetes Helm charts as a Helm plugin.
