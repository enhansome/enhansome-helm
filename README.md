...
* [Mocktail](https://github.com/Huseyinnurbaki/mocktail) ⭐ 245 | 🐛 20 | 🌐 TypeScript | 📅 2026-08-14 - Helm chart for deploying the free, tiny mock api server Mocktail
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 127 | 🐛 22 | 🌐 TypeScript | 📅 2026-08-14 - AI-powered multi-cluster Kubernetes management console with built-in Helm chart for one-command deployment
...
* [Helm Secrets](https://github.com/jkroepke/helm-secrets) ⭐ 2,023 | 🐛 3 | 🌐 Shell | 📅 2026-08-14 - Plugin to manage and store secrets safely.
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 127 | 🐛 22 | 🌐 TypeScript | 📅 2026-08-14 - Multi-cluster Kubernetes dashboard with Helm chart deployment, deployed via its own Helm chart for easy installation
