...
* [Harbor](https://github.com/goharbor/harbor-helm) ⭐ 1,522 | 🐛 68 | 🌐 Mustache | 📅 2026-09-14 - Harbor is a container and Helm registry with built-in security
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 137 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-21 - AI-powered multi-cluster Kubernetes management console with built-in Helm chart for one-command deployment
...
* [Helm Unittest](https://github.com/helm-unittest/helm-unittest) ⭐ 1,391 | 🐛 85 | 🌐 Go | 📅 2026-09-18 - Plugin that enables you to run BDD style unit tests against rendered Helm charts. Adds the `helm unittest` command to execute tests.
...
* [Helm Schema](https://github.com/dadav/helm-schema) ⭐ 285 | 🐛 12 | 🌐 Go | 📅 2026-09-21 - Auto-generate jsonschema files for helm charts.
...
* [Helmsman](https://github.com/Praqma/helmsman) ⭐ 1,498 | 🐛 1 | 🌐 Go | 📅 2026-09-20 - Helmsman provides a declarative way of installing charts, features terraform-like desired state file approach and security enhancements
...
* [Chart Releaser](https://github.com/helm/chart-releaser) ⭐ 783 | 🐛 54 | 🌐 Go | 📅 2026-09-21 - Helps Turn GitHub Repositories into Helm Chart Repositories
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 137 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-21 - Multi-cluster Kubernetes dashboard with Helm chart deployment, deployed via its own Helm chart for easy installation
...
* [helm-unittest](https://github.com/helm-unittest/helm-unittest) ⭐ 1,391 | 🐛 85 | 🌐 Go | 📅 2026-09-18 - BDD styled unit test framework for Kubernetes Helm charts as a Helm plugin.
