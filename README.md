...
* [Harbor](https://github.com/goharbor/harbor-helm) ⭐ 1,521 | 🐛 68 | 🌐 Mustache | 📅 2026-09-14 - Harbor is a container and Helm registry with built-in security
* [OpenStack](https://github.com/openstack/openstack-helm) ⭐ 576 | 🐛 0 | 🌐 Shell | 📅 2026-09-18 - various charts by the OpenStack project
* [Mocktail](https://github.com/Huseyinnurbaki/mocktail) ⭐ 276 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-20 - Helm chart for deploying the free, tiny mock api server Mocktail
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 137 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-20 - AI-powered multi-cluster Kubernetes management console with built-in Helm chart for one-command deployment
...
* [Helm Diff](https://github.com/databus23/helm-diff) ⭐ 3,493 | 🐛 50 | 🌐 Go | 📅 2026-09-17 - Plugin that shows a diff explaing what a `helm upgrade` and `helm rollback` would change. It can also compare two separate revisions of the release.
* [Helm Secrets](https://github.com/jkroepke/helm-secrets) ⭐ 2,029 | 🐛 1 | 🌐 Shell | 📅 2026-09-11 - Plugin to manage and store secrets safely.
* [Helm Unittest](https://github.com/helm-unittest/helm-unittest) ⭐ 1,390 | 🐛 85 | 🌐 Go | 📅 2026-09-18 - Plugin that enables you to run BDD style unit tests against rendered Helm charts. Adds the `helm unittest` command to execute tests.
...
* [Helmify](https://github.com/arttor/helmify) ⭐ 1,743 | 🐛 60 | 🌐 Go | 📅 2026-05-07 - Generates a Helm chart from Kubernetes yamls
* [Helmsman](https://github.com/Praqma/helmsman) ⭐ 1,498 | 🐛 1 | 🌐 Go | 📅 2026-09-19 - Helmsman provides a declarative way of installing charts, features terraform-like desired state file approach and security enhancements
...
* [Reckoner](https://github.com/FairwindsOps/reckoner) ⭐ 355 | 🐛 9 | 🌐 Go | 📅 2026-09-18 - Reckoner is a tool to simplify management and installation of multiple Helm chart releases
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 137 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-20 - Multi-cluster Kubernetes dashboard with Helm chart deployment, deployed via its own Helm chart for easy installation
...
* [Qovery](https://www.qovery.com/) - Enterprise Kubernetes management platform that natively deploys Helm charts from public/private repositories or Git repos. Includes Terraform provider, CLI, API, and [AI Agent Skill](https://github.com/Qovery/qovery-skills) ⭐ 12 | 🐛 4 | 🌐 Shell | 📅 2026-09-19 for AI-assisted deployment.
...
* [`ct`, Official CLI for testing](https://github.com/helm/chart-testing) ⭐ 1,640 | 🐛 3 | 🌐 Go | 📅 2026-09-16 - CLI tool for linting and testing Helm charts.
* [helm-unittest](https://github.com/helm-unittest/helm-unittest) ⭐ 1,390 | 🐛 85 | 🌐 Go | 📅 2026-09-18 - BDD styled unit test framework for Kubernetes Helm charts as a Helm plugin.
...
Check out the [Contributing Guidelines](https://github.com/cdwv/awesome-helm/blob/master/CONTRIBUTING.md) ⭐ 1,113 | 🐛 8 | 📅 2026-05-16.
