...
* [Harbor](https://github.com/goharbor/harbor-helm) ⭐ 1,510 | 🐛 73 | 🌐 Mustache | 📅 2026-08-03 - Harbor is a container and Helm registry with built-in security
* [OpenStack](https://github.com/openstack/openstack-helm) ⭐ 574 | 🐛 0 | 🌐 Shell | 📅 2026-08-17 - various charts by the OpenStack project
* [Mocktail](https://github.com/Huseyinnurbaki/mocktail) ⭐ 272 | 🐛 20 | 🌐 TypeScript | 📅 2026-08-15 - Helm chart for deploying the free, tiny mock api server Mocktail
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 128 | 🐛 40 | 🌐 TypeScript | 📅 2026-08-18 - AI-powered multi-cluster Kubernetes management console with built-in Helm chart for one-command deployment
...
* [Helm Diff](https://github.com/databus23/helm-diff) ⭐ 3,481 | 🐛 54 | 🌐 Go | 📅 2026-08-17 - Plugin that shows a diff explaing what a `helm upgrade` and `helm rollback` would change. It can also compare two separate revisions of the release.
* [Helm Secrets](https://github.com/jkroepke/helm-secrets) ⭐ 2,024 | 🐛 2 | 🌐 Shell | 📅 2026-08-14 - Plugin to manage and store secrets safely.
* [Helm Unittest](https://github.com/helm-unittest/helm-unittest) ⭐ 1,383 | 🐛 81 | 🌐 Go | 📅 2026-08-17 - Plugin that enables you to run BDD style unit tests against rendered Helm charts. Adds the `helm unittest` command to execute tests.
...
* [Brigade](https://github.com/brigadecore/brigade) ⭐ 2,412 | 🐛 31 | 🌐 Go | 📅 2023-03-07 - A tool for running scriptable, automated tasks in the cloud — as part of your Kubernetes cluster
* [Helm Docs](https://github.com/norwoodj/helm-docs) ⭐ 1,758 | 🐛 97 | 🌐 Go | 📅 2026-06-22 - Auto-generates documentation from helm charts into markdown files
...
* [Chart Releaser](https://github.com/helm/chart-releaser) ⭐ 784 | 🐛 67 | 🌐 Go | 📅 2026-08-17 - Helps Turn GitHub Repositories into Helm Chart Repositories
...
* [Readme Generator](https://github.com/bitnami-labs/readme-generator-for-helm) ⭐ 311 | 🐛 4 | 🌐 JavaScript | 📅 2026-08-17 - Autogenerate Helm Charts READMEs' tables based on values YAML file metadata.
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 128 | 🐛 40 | 🌐 TypeScript | 📅 2026-08-18 - Multi-cluster Kubernetes dashboard with Helm chart deployment, deployed via its own Helm chart for easy installation
...
* [Qovery](https://www.qovery.com/) - Enterprise Kubernetes management platform that natively deploys Helm charts from public/private repositories or Git repos. Includes Terraform provider, CLI, API, and [AI Agent Skill](https://github.com/Qovery/qovery-skills) ⭐ 9 | 🐛 4 | 🌐 Shell | 📅 2026-08-18 for AI-assisted deployment.
...
* [helm-unittest](https://github.com/helm-unittest/helm-unittest) ⭐ 1,383 | 🐛 81 | 🌐 Go | 📅 2026-08-17 - BDD styled unit test framework for Kubernetes Helm charts as a Helm plugin.
