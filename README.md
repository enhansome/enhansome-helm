...
* [Harbor](https://github.com/goharbor/harbor-helm) ⭐ 1,511 | 🐛 72 | 🌐 Mustache | 📅 2026-08-03 - Harbor is a container and Helm registry with built-in security
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 127 | 🐛 34 | 🌐 TypeScript | 📅 2026-08-24 - AI-powered multi-cluster Kubernetes management console with built-in Helm chart for one-command deployment
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 127 | 🐛 34 | 🌐 TypeScript | 📅 2026-08-24 - Multi-cluster Kubernetes dashboard with Helm chart deployment, deployed via its own Helm chart for easy installation
