...
* [Harbor](https://github.com/goharbor/harbor-helm) ⭐ 1,521 | 🐛 69 | 🌐 Mustache | 📅 2026-09-14 - Harbor is a container and Helm registry with built-in security
* [OpenStack](https://github.com/openstack/openstack-helm) ⭐ 576 | 🐛 0 | 🌐 Shell | 📅 2026-09-16 - various charts by the OpenStack project
* [Mocktail](https://github.com/Huseyinnurbaki/mocktail) ⭐ 276 | 🐛 21 | 🌐 TypeScript | 📅 2026-08-20 - Helm chart for deploying the free, tiny mock api server Mocktail
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 137 | 🐛 15 | 🌐 TypeScript | 📅 2026-09-18 - AI-powered multi-cluster Kubernetes management console with built-in Helm chart for one-command deployment
...
* [Helm Diff](https://github.com/databus23/helm-diff) ⭐ 3,492 | 🐛 50 | 🌐 Go | 📅 2026-09-17 - Plugin that shows a diff explaing what a `helm upgrade` and `helm rollback` would change. It can also compare two separate revisions of the release.
* [Helm Secrets](https://github.com/jkroepke/helm-secrets) ⭐ 2,028 | 🐛 1 | 🌐 Shell | 📅 2026-09-11 - Plugin to manage and store secrets safely.
* [Helm Unittest](https://github.com/helm-unittest/helm-unittest) ⭐ 1,390 | 🐛 85 | 🌐 Go | 📅 2026-09-14 - Plugin that enables you to run BDD style unit tests against rendered Helm charts. Adds the `helm unittest` command to execute tests.
...
* [Helm Schema](https://github.com/dadav/helm-schema) ⭐ 285 | 🐛 11 | 🌐 Go | 📅 2026-09-08 - Auto-generate jsonschema files for helm charts.
* [Helm GCS](https://github.com/hayorov/helm-gcs) ⭐ 284 | 🐛 9 | 🌐 Go | 📅 2026-09-17 - Plugin that manages chart repos on Google Cloud Storage privately.
...
* [Helm Release](https://github.com/JovianX/helm-release-plugin) ⭐ 114 | 🐛 12 | 🌐 Shell | 📅 2026-03-29 - Plugin that pulls(re-creates) Helm charts from deployed releases, also allows update values of deployed releases without supplying the chart(for modified or custom charts, or when there's no access to the chart)
* [Helm Dt](https://github.com/vmware-labs/distribution-tooling-for-helm) ⭐ 110 | 🐛 11 | 🌐 Go | 📅 2026-07-22 - Plugin that helps moving Helm charts across OCI registries.
* [Helm Teller](https://github.com/SpectralOps/helm-teller) ⭐ 69 | 🐛 1 | 🌐 Go | 📅 2022-11-14 - Plugin that allows you to manage deployment configuration and secrets from multiple providers securely with [Teller](https://github.com/SpectralOps/teller) ⭐ 3,229 | 🐛 51 | 🌐 Rust | 📅 2026-01-27
* [Helm Starter](https://github.com/salesforce/helm-starter) ⭐ 63 | 🐛 3 | 🌐 Shell | 📅 2026-06-02 - Plugin that simplifies working with helm chart starter packs.
* [Helm Kanvas Snapshot](https://github.com/meshery/helm-kanvas-snapshot) ⭐ 45 | 🐛 14 | 🌐 Go | 📅 2026-09-01 - Plugin that generates a visual snapshot of Helm charts.
...
* [Helmfile](https://github.com/roboll/helmfile) ⭐ 4,032 | 🐛 527 | 🌐 Go | 📅 2023-04-27 - Helmfile is a declarative spec for deploying helm charts, supports flexible templating scenarios
* [Brigade](https://github.com/brigadecore/brigade) ⭐ 2,419 | 🐛 31 | 🌐 Go | 📅 2023-03-07 - A tool for running scriptable, automated tasks in the cloud — as part of your Kubernetes cluster
* [Helm Docs](https://github.com/norwoodj/helm-docs) ⭐ 1,764 | 🐛 98 | 🌐 Go | 📅 2026-06-22 - Auto-generates documentation from helm charts into markdown files
* [Helmify](https://github.com/arttor/helmify) ⭐ 1,742 | 🐛 60 | 🌐 Go | 📅 2026-05-07 - Generates a Helm chart from Kubernetes yamls
* [Helmsman](https://github.com/Praqma/helmsman) ⭐ 1,498 | 🐛 2 | 🌐 Go | 📅 2026-09-18 - Helmsman provides a declarative way of installing charts, features terraform-like desired state file approach and security enhancements
...
* [Chart Releaser](https://github.com/helm/chart-releaser) ⭐ 783 | 🐛 53 | 🌐 Go | 📅 2026-09-17 - Helps Turn GitHub Repositories into Helm Chart Repositories
...
* [Reckoner](https://github.com/FairwindsOps/reckoner) ⭐ 354 | 🐛 13 | 🌐 Go | 📅 2026-09-17 - Reckoner is a tool to simplify management and installation of multiple Helm chart releases
* [Kubesafe](https://github.com/Telemaco019/kubesafe) ⭐ 338 | 🐛 0 | 🌐 Go | 📅 2026-08-25 - Safely manage multiple Kubernetes clusters by defining safe contexts and protected commands.
* [Readme Generator](https://github.com/bitnami-labs/readme-generator-for-helm) ⭐ 311 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-14 - Autogenerate Helm Charts READMEs' tables based on values YAML file metadata.
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 137 | 🐛 15 | 🌐 TypeScript | 📅 2026-09-18 - Multi-cluster Kubernetes dashboard with Helm chart deployment, deployed via its own Helm chart for easy installation
...
* [Kube Foundry](https://github.com/kube-foundry/kube-foundry) ⭐ 20 | 🐛 3 | 🌐 Go | 📅 2026-04-01 - Kubernetes operator that runs AI coding agents (Claude Code, Codex, Cursor, Gemini, OpenCode) in sandboxed pods. Deploys via Helm chart.
...
* [Qovery](https://www.qovery.com/) - Enterprise Kubernetes management platform that natively deploys Helm charts from public/private repositories or Git repos. Includes Terraform provider, CLI, API, and [AI Agent Skill](https://github.com/Qovery/qovery-skills) ⭐ 11 | 🐛 4 | 🌐 Shell | 📅 2026-09-17 for AI-assisted deployment.
...
* [`ct`, Official CLI for testing](https://github.com/helm/chart-testing) ⭐ 1,639 | 🐛 3 | 🌐 Go | 📅 2026-09-16 - CLI tool for linting and testing Helm charts.
* [helm-unittest](https://github.com/helm-unittest/helm-unittest) ⭐ 1,390 | 🐛 85 | 🌐 Go | 📅 2026-09-14 - BDD styled unit test framework for Kubernetes Helm charts as a Helm plugin.
* [helm-chartsnap](https://github.com/jlandowner/helm-chartsnap) ⭐ 110 | 🐛 16 | 🌐 Go | 📅 2026-09-18 - Snapshot testing tool for Helm charts. Allows you to compare the rendered output of a Helm chart against a snapshot.
...
Check out the [Contributing Guidelines](https://github.com/cdwv/awesome-helm/blob/master/CONTRIBUTING.md) ⭐ 1,111 | 🐛 9 | 📅 2026-05-16.
