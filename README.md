...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 130 | 🐛 10 | 🌐 TypeScript | 📅 2026-08-30 - AI-powered multi-cluster Kubernetes management console with built-in Helm chart for one-command deployment
...
* [Helm Diff](https://github.com/databus23/helm-diff) ⭐ 3,484 | 🐛 50 | 🌐 Go | 📅 2026-08-30 - Plugin that shows a diff explaing what a `helm upgrade` and `helm rollback` would change. It can also compare two separate revisions of the release.
...
* [Helm GCS](https://github.com/hayorov/helm-gcs) ⭐ 284 | 🐛 8 | 🌐 Go | 📅 2026-08-30 - Plugin that manages chart repos on Google Cloud Storage privately.
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 130 | 🐛 10 | 🌐 TypeScript | 📅 2026-08-30 - Multi-cluster Kubernetes dashboard with Helm chart deployment, deployed via its own Helm chart for easy installation
...
* [`ct`, Official CLI for testing](https://github.com/helm/chart-testing) ⭐ 1,640 | 🐛 6 | 🌐 Go | 📅 2026-08-24 - CLI tool for linting and testing Helm charts.
