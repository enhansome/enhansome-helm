...
* [OpenStack](https://github.com/openstack/openstack-helm) ⭐ 575 | 🐛 0 | 🌐 Shell | 📅 2026-09-09 - various charts by the OpenStack project
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 133 | 🐛 168 | 🌐 TypeScript | 📅 2026-09-09 - AI-powered multi-cluster Kubernetes management console with built-in Helm chart for one-command deployment
...
* [Helm Diff](https://github.com/databus23/helm-diff) ⭐ 3,488 | 🐛 51 | 🌐 Go | 📅 2026-09-09 - Plugin that shows a diff explaing what a `helm upgrade` and `helm rollback` would change. It can also compare two separate revisions of the release.
* [Helm Secrets](https://github.com/jkroepke/helm-secrets) ⭐ 2,027 | 🐛 1 | 🌐 Shell | 📅 2026-09-04 - Plugin to manage and store secrets safely.
...
* [Chart Releaser](https://github.com/helm/chart-releaser) ⭐ 783 | 🐛 56 | 🌐 Go | 📅 2026-09-09 - Helps Turn GitHub Repositories into Helm Chart Repositories
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 133 | 🐛 168 | 🌐 TypeScript | 📅 2026-09-09 - Multi-cluster Kubernetes dashboard with Helm chart deployment, deployed via its own Helm chart for easy installation
