...
* [OpenStack](https://github.com/openstack/openstack-helm) ⭐ 574 | 🐛 0 | 🌐 Shell | 📅 2026-08-25 - various charts by the OpenStack project
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 127 | 🐛 49 | 🌐 TypeScript | 📅 2026-08-26 - AI-powered multi-cluster Kubernetes management console with built-in Helm chart for one-command deployment
...
* [Helm Diff](https://github.com/databus23/helm-diff) ⭐ 3,484 | 🐛 52 | 🌐 Go | 📅 2026-08-24 - Plugin that shows a diff explaing what a `helm upgrade` and `helm rollback` would change. It can also compare two separate revisions of the release.
...
* [Helm GCS](https://github.com/hayorov/helm-gcs) ⭐ 284 | 🐛 8 | 🌐 Go | 📅 2026-08-25 - Plugin that manages chart repos on Google Cloud Storage privately.
...
* [Helm Docs](https://github.com/norwoodj/helm-docs) ⭐ 1,761 | 🐛 98 | 🌐 Go | 📅 2026-06-22 - Auto-generates documentation from helm charts into markdown files
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 127 | 🐛 49 | 🌐 TypeScript | 📅 2026-08-26 - Multi-cluster Kubernetes dashboard with Helm chart deployment, deployed via its own Helm chart for easy installation
