...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 133 | 🐛 149 | 🌐 TypeScript | 📅 2026-09-12 - AI-powered multi-cluster Kubernetes management console with built-in Helm chart for one-command deployment
...
* [Helm Unittest](https://github.com/helm-unittest/helm-unittest) ⭐ 1,391 | 🐛 83 | 🌐 Go | 📅 2026-09-11 - Plugin that enables you to run BDD style unit tests against rendered Helm charts. Adds the `helm unittest` command to execute tests.
...
* [Helmsman](https://github.com/Praqma/helmsman) ⭐ 1,492 | 🐛 2 | 🌐 Go | 📅 2026-09-09 - Helmsman provides a declarative way of installing charts, features terraform-like desired state file approach and security enhancements
...
* [Reckoner](https://github.com/FairwindsOps/reckoner) ⭐ 354 | 🐛 15 | 🌐 Go | 📅 2026-09-07 - Reckoner is a tool to simplify management and installation of multiple Helm chart releases
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 133 | 🐛 149 | 🌐 TypeScript | 📅 2026-09-12 - Multi-cluster Kubernetes dashboard with Helm chart deployment, deployed via its own Helm chart for easy installation
...
* [Kube Foundry](https://github.com/kube-foundry/kube-foundry) ⭐ 19 | 🐛 3 | 🌐 Go | 📅 2026-04-01 - Kubernetes operator that runs AI coding agents (Claude Code, Codex, Cursor, Gemini, OpenCode) in sandboxed pods. Deploys via Helm chart.
...
* [helm-unittest](https://github.com/helm-unittest/helm-unittest) ⭐ 1,391 | 🐛 83 | 🌐 Go | 📅 2026-09-11 - BDD styled unit test framework for Kubernetes Helm charts as a Helm plugin.
