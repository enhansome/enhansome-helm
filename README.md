...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 127 | 🐛 23 | 🌐 TypeScript | 📅 2026-08-22 - AI-powered multi-cluster Kubernetes management console with built-in Helm chart for one-command deployment
...
* [Helm Schema](https://github.com/dadav/helm-schema) ⭐ 281 | 🐛 12 | 🌐 Go | 📅 2026-08-17 - Auto-generate jsonschema files for helm charts.
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 127 | 🐛 23 | 🌐 TypeScript | 📅 2026-08-22 - Multi-cluster Kubernetes dashboard with Helm chart deployment, deployed via its own Helm chart for easy installation
