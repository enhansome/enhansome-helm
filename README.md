...
* [Harbor](https://github.com/goharbor/harbor-helm) ⭐ 1,514 | 🐛 73 | 🌐 Mustache | 📅 2026-08-03 - Harbor is a container and Helm registry with built-in security
* [OpenStack](https://github.com/openstack/openstack-helm) ⭐ 574 | 🐛 0 | 🌐 Shell | 📅 2026-09-01 - various charts by the OpenStack project
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 131 | 🐛 46 | 🌐 TypeScript | 📅 2026-09-02 - AI-powered multi-cluster Kubernetes management console with built-in Helm chart for one-command deployment
...
* [Helm Diff](https://github.com/databus23/helm-diff) ⭐ 3,488 | 🐛 51 | 🌐 Go | 📅 2026-09-01 - Plugin that shows a diff explaing what a `helm upgrade` and `helm rollback` would change. It can also compare two separate revisions of the release.
...
* [Helm S3](https://github.com/hypnoglow/helm-s3) ⭐ 614 | 🐛 42 | 🌐 Go | 📅 2026-09-02 - Plugin to fetch charts from S3.
...
* [Helm GCS](https://github.com/hayorov/helm-gcs) ⭐ 284 | 🐛 6 | 🌐 Go | 📅 2026-09-02 - Plugin that manages chart repos on Google Cloud Storage privately.
* [Helm Schema](https://github.com/dadav/helm-schema) ⭐ 281 | 🐛 11 | 🌐 Go | 📅 2026-08-31 - Auto-generate jsonschema files for helm charts.
...
* [Chart Releaser](https://github.com/helm/chart-releaser) ⭐ 783 | 🐛 67 | 🌐 Go | 📅 2026-09-02 - Helps Turn GitHub Repositories into Helm Chart Repositories
...
* [Reckoner](https://github.com/FairwindsOps/reckoner) ⭐ 354 | 🐛 13 | 🌐 Go | 📅 2026-09-01 - Reckoner is a tool to simplify management and installation of multiple Helm chart releases
...
* [Readme Generator](https://github.com/bitnami-labs/readme-generator-for-helm) ⭐ 311 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-02 - Autogenerate Helm Charts READMEs' tables based on values YAML file metadata.
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 131 | 🐛 46 | 🌐 TypeScript | 📅 2026-09-02 - Multi-cluster Kubernetes dashboard with Helm chart deployment, deployed via its own Helm chart for easy installation
...
* [Qovery](https://www.qovery.com/) - Enterprise Kubernetes management platform that natively deploys Helm charts from public/private repositories or Git repos. Includes Terraform provider, CLI, API, and [AI Agent Skill](https://github.com/Qovery/qovery-skills) ⭐ 10 | 🐛 3 | 🌐 Shell | 📅 2026-09-01 for AI-assisted deployment.
