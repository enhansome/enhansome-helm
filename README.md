...
* [Harbor](https://github.com/goharbor/harbor-helm) ⭐ 1,523 | 🐛 68 | 🌐 Mustache | 📅 2026-09-14 - Harbor is a container and Helm registry with built-in security
* [OpenStack](https://github.com/openstack/openstack-helm) ⭐ 576 | 🐛 0 | 🌐 Shell | 📅 2026-09-24 - various charts by the OpenStack project
* [Mocktail](https://github.com/Huseyinnurbaki/mocktail) ⭐ 277 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-20 - Helm chart for deploying the free, tiny mock api server Mocktail
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 138 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-24 - AI-powered multi-cluster Kubernetes management console with built-in Helm chart for one-command deployment
...
* [Helm Diff](https://github.com/databus23/helm-diff) ⭐ 3,497 | 🐛 50 | 🌐 Go | 📅 2026-09-17 - Plugin that shows a diff explaing what a `helm upgrade` and `helm rollback` would change. It can also compare two separate revisions of the release.
* [Helm Secrets](https://github.com/jkroepke/helm-secrets) ⭐ 2,031 | 🐛 1 | 🌐 Shell | 📅 2026-09-23 - Plugin to manage and store secrets safely.
* [Helm Unittest](https://github.com/helm-unittest/helm-unittest) ⭐ 1,393 | 🐛 87 | 🌐 Go | 📅 2026-09-21 - Plugin that enables you to run BDD style unit tests against rendered Helm charts. Adds the `helm unittest` command to execute tests.
...
* [Helm Schema](https://github.com/dadav/helm-schema) ⭐ 286 | 🐛 11 | 🌐 Go | 📅 2026-09-21 - Auto-generate jsonschema files for helm charts.
* [Helm GCS](https://github.com/hayorov/helm-gcs) ⭐ 284 | 🐛 9 | 🌐 Go | 📅 2026-09-21 - Plugin that manages chart repos on Google Cloud Storage privately.
...
* [Helm Release](https://github.com/JovianX/helm-release-plugin) ⭐ 114 | 🐛 13 | 🌐 Shell | 📅 2026-03-29 - Plugin that pulls(re-creates) Helm charts from deployed releases, also allows update values of deployed releases without supplying the chart(for modified or custom charts, or when there's no access to the chart)
...
* [Helm Teller](https://github.com/SpectralOps/helm-teller) ⭐ 69 | 🐛 1 | 🌐 Go | 📅 2022-11-14 - Plugin that allows you to manage deployment configuration and secrets from multiple providers securely with [Teller](https://github.com/SpectralOps/teller) ⭐ 3,231 | 🐛 52 | 🌐 Rust | 📅 2026-01-27
...
* [Helm Docs](https://github.com/norwoodj/helm-docs) ⭐ 1,765 | 🐛 99 | 🌐 Go | 📅 2026-06-22 - Auto-generates documentation from helm charts into markdown files
...
* [Chart Releaser](https://github.com/helm/chart-releaser) ⭐ 783 | 🐛 53 | 🌐 Go | 📅 2026-09-21 - Helps Turn GitHub Repositories into Helm Chart Repositories
...
* [Readme Generator](https://github.com/bitnami-labs/readme-generator-for-helm) ⭐ 312 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-22 - Autogenerate Helm Charts READMEs' tables based on values YAML file metadata.
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 138 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-24 - Multi-cluster Kubernetes dashboard with Helm chart deployment, deployed via its own Helm chart for easy installation
...
* [Qovery](https://www.qovery.com/) - Enterprise Kubernetes management platform that natively deploys Helm charts from public/private repositories or Git repos. Includes Terraform provider, CLI, API, and [AI Agent Skill](https://github.com/Qovery/qovery-skills) ⭐ 12 | 🐛 4 | 🌐 Shell | 📅 2026-09-21 for AI-assisted deployment.
...
* [`ct`, Official CLI for testing](https://github.com/helm/chart-testing) ⭐ 1,641 | 🐛 3 | 🌐 Go | 📅 2026-09-22 - CLI tool for linting and testing Helm charts.
* [helm-unittest](https://github.com/helm-unittest/helm-unittest) ⭐ 1,393 | 🐛 87 | 🌐 Go | 📅 2026-09-21 - BDD styled unit test framework for Kubernetes Helm charts as a Helm plugin.
* [helm-chartsnap](https://github.com/jlandowner/helm-chartsnap) ⭐ 111 | 🐛 17 | 🌐 Go | 📅 2026-09-21 - Snapshot testing tool for Helm charts. Allows you to compare the rendered output of a Helm chart against a snapshot.
...
Check out the [Contributing Guidelines](https://github.com/cdwv/awesome-helm/blob/master/CONTRIBUTING.md) ⭐ 1,116 | 🐛 9 | 📅 2026-05-16.
